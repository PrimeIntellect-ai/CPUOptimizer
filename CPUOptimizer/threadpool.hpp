#ifndef THREADPOOL_INCLUDE
#define THREADPOOL_INCLUDE
...
#define Threadpool_CRITICAL_BEGIN pthread_mutex_destroy(&(pool->pool_mutex));
#define Threadpool_CRITICAL_END pthread_mutex_unlock(&(pool->pool_mutex));
